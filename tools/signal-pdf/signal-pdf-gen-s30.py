...
SEMANA = "30"
PERIODO = "20 a 24 de julho de 2026"
DATA_GERACAO = "07/08/2026"
...
METRICAS = [
    ...
    ("11", "Novos termos"),
    ("v4.8", "Dicionário Oficial"),
]
FATOS = [
    {
        "tag": "RELAÇÕES INSTITUCIONAIS",
        "titulo": "Rescisão Grupo IAG Saúde — Notificação formal (22/07)",
        "resumo": "Encerramento unilateral do contrato de parceria comercial Axia × IAG. Breno Duarte acusou recebimento. Decisão estratégica de reposicionamento de parcerias externas.",
    },
    {
        "tag": "PARCERIAS",
        "titulo": "Contrato 2iM — Módulo GRP assinado via Clicksign (24/07)",
        "resumo": "Formaliza modelo PBV (Pagamento Baseado em Valor) com Score de Valor. Milva Brito (2iM) + Márcio Silveira (Unimed GV). Gestão de Resultados por Pagamento operacional.",
    },
    {
        "tag": "JORNADA CIRÚRGICA",
        "titulo": "Adesão do Dr. Anderson ao piloto — Projeto Axys (Teller)",
        "resumo": "Apresentação do projeto de jornada pré-cirúrgica estruturada. Canal aberto para alinhamentos. Próximo passo: capacitação da secretária no Hilum e verificação OPMEs.",
    },
    {
        "tag": "ASSISTENCIAL",
        "titulo": "Ficha Admissão GCE (FRM-EVS-2026-003) — Validação iniciada",
        "resumo": "Naline encaminhou à equipe (24/07). Camila Borba pontuou adaptações para pacientes domiciliares. KPS × Score GCE. Versão Navia concluída.",
    },
    {
        "tag": "ESTRATÉGIA",
        "titulo": "Consolidação EVS para SUEMG/ES — Rascunho entregue",
        "resumo": "Apresentação executiva única ao Dr. Guilherme. R$ 3,19M valor hospitalar, R$ 11,4M economia Ymunity, 3.061 diárias evitadas, 1.344 TEA. Apresentação ago/2026.",
    },
    {
        "tag": "QUALIDADE",
        "titulo": "Capacitação Metas de Segurança — Unihealth (20-21/07)",
        "resumo": "Parceria NSP + SCIH. Duas metas treinadas no quadrimestre. Elegibilidade consolidada para acréscimo de +5% na bonificação DRG.",
    },
]
OBSERVACOES = [
    "Navia: 463-465 pacientes totais (409-411 ativos), pipeline oncológico estável.",
    "Boletim Intercâmbio: 3.ª lista de medicamentos oncológicos por princípio ativo (Anilda Duarte).",
    "Capacitação Glosas Ajius: Unimed GV + Unimed Araguari confirmadas (Cleverson Almeida).",
    "Planilha unificada Viver Bem concluída; levantamento claims 18 meses em fase final.",
]
...
if __name__ == "__main__":
    out = os.path.join(SCRIPT_DIR, "Signal_S30_2026.pdf")
