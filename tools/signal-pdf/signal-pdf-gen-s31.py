...
SEMANA = "31"
PERIODO = "27 a 31 de julho de 2026"
DATA_GERACAO = "21/08/2026"
...
METRICAS = [
    ...
    ("7", "Novos termos"),
    ("v4.9", "Dicionário Oficial"),
]

FATOS = [
    {
        "tag": "PARCERIAS",
        "titulo": "Reunião AbbVie agendada (31/07)",
        "resumo": "Avaliação de oportunidades de parceria com a farmacêutica multinacional. Temáticas de interesse mútuo com Dr. Guilherme.",
    },
    {
        "tag": "ESTRATÉGIA",
        "titulo": "Divulgação Projeto 2iM — Aprovação Diretoria (31/07)",
        "resumo": "Peças de divulgação aprovadas pela Diretoria da Unimed GV. Publicação autorizada. Ajuste pontual solicitado pela Diretoria.",
    },
    {
        "tag": "NAVEGAÇÃO",
        "titulo": "Transição biossimilar — Caso Letícia Ribeiro Baltar",
        "resumo": "Navegação Ymunity identificou que paciente ainda recebia medicamento original após dispensação de 6 meses. Coordenação multissetorial em andamento.",
    },
    {
        "tag": "RELAÇÕES INSTITUCIONAIS",
        "titulo": "NDA Unimed Axis — ICDS — Unimed Araraquara (29/07)",
        "resumo": "Acordo de confidencialidade formalizado. Ana Beatriz Farah (ICDS) + César Izique (Unimed Araraquara). Projeto estratégico em fase inicial.",
    },
    {
        "tag": "ONCOLOGIA",
        "titulo": "LC CA Mama consolidada como Linha de Cuidado (EVS)",
        "resumo": "Base revisada: 141 pacientes. Segregação analítica CA Mama × CA Ginecológico. Aderência ICHOM (Breast Cancer Standard Set) deliberada.",
    },
    {
        "tag": "ASSISTENCIAL",
        "titulo": "Ymunity — Alinhamento mensal (29/07)",
        "resumo": "Protocolo Rinvoq finalizado. Protocolos pré-infusionais no MV. PROMs priorizadas (Reumatologia, Psoríase). Evento biossimilares (Celltrion) planejado.",
    },
]

OBSERVACOES = [
    "Navia: 468 pacientes totais (414 ativos), pipeline oncológico estável.",
    "CMM: conta Naline criada (Catálogo de Materiais e Medicamentos).",
    "Levantamento produção Lab. Alvarenga (jan-jun/2026) entregue.",
    "Painel Tempo de Espera PS: solicitação de contato técnico TI ICDS.",
]
...
if __name__ == "__main__":
    out = os.path.join(SCRIPT_DIR, "Signal_S31_2026.pdf")
