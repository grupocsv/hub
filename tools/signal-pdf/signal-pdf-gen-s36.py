...
SEMANA = "36"
PERIODO = "31 de agosto a 4 de setembro de 2026"
DATA_GERACAO = "11/09/2026"
...
FATOS = [
    {
        "tag": "FINANCEIRO",
        "titulo": "RMBV supera a meta no segundo quadrimestre",
        "resumo": "O grupo alcançou média de 93,9 frente à meta de 90, com 4 de 5 participantes acima da referência. A consolidação será a base oficial para processamento do bônus.",
    },
    {
        "tag": "LINHAS DE CUIDADO",
        "titulo": "Caminhos Brilhantes redefine a jornada do TEA",
        "resumo": "O novo fluxo combina pré-atendimento remoto e consulta neuropediátrica conclusiva, com meta de até cinco semanas. A modelagem terá 9 a 12 bundles por cluster.",
    },
    {
        "tag": "IMUNOBIOLÓGICOS",
        "titulo": "Ymunity implanta duplo parecer e régua preventiva",
        "resumo": "Conformidade regulatória e recomendação clínica passam a ser avaliadas separadamente. Para 269 pacientes, haverá controle documental e alertas aos 60 e 30 dias.",
    },
    {
        "tag": "DADOS",
        "titulo": "Assessment 2iM conclui a etapa de ingestão",
        "resumo": "O De/Para de especialidades e os complementos da base permitiram atualizar o assessment. O documento segue para validação interna antes das próximas fases.",
    },
    {
        "tag": "GOVERNANÇA",
        "titulo": "Contrato da Hi! avança para assinaturas",
...
if __name__ == "__main__":
    out = os.path.join(SCRIPT_DIR, "Signal_S36_2026.pdf")
