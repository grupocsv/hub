...
SEMANA = "28"
PERIODO = "06 a 10 de julho de 2026"
DATA_GERACAO = "17/07/2026"
...
METRICAS = [
    ...
    ("4", "Novos termos"),
    ("v4.6", "Dicionário Oficial"),
]
FATOS = [
    {
        "tag": "DESEMPENHO",
        "titulo": "Report DRG 1S2026 — Concluído e apresentado",
        "resumo": "Ciclo analítico Jan-Jun 2026. Eficiência do leito, IQIC, mortalidade ajustada por risco, readmissões, PPE-15. Visão integrada do desempenho institucional entregue à Diretoria Executiva.",
    },
    {
        "tag": "NEURODESENVOLVIMENTO",
        "titulo": "IBRAVS x Unimed GV — Alinhamento Operacional TEA (07/07)",
        "resumo": "Reunião de 1h48min. Modelo assistencial baseado em clusterização e valor. Capacitação CIF/CBDF, reorganização sala neuroinfantil, ampliação de sessões. Próxima reunião 21/07.",
    },
    {
        "tag": "AUDITORIA",
        "titulo": "Análise ABA/Psicologia — Rede Própria vs Rede Externa",
        "resumo": "Documento técnico confidencial entregue ao CTE (10/07). Recorte 2025. Intensidade assistencial comparada entre rede própria e rede externa. Subsídio para decisão de expansão.",
    },
    {
        "tag": "TECNOLOGIA",
        "titulo": "Navia — Operação Estável (458 pacientes)",
        "resumo": "404 pacientes ativos. 7 novos pacientes/dia. Pipeline de ingestão oncológica ativo. Plataforma de Gestão de Linhas de Cuidado em operação contínua.",
    },
    {
        "tag": "LINHAS DE CUIDADO",
        "titulo": "Ymunity — Transição para Biossimilares em curso",
        "resumo": "Monitoramento 06-10/jul. Novas solicitações terapêuticas e atualizações de protocolo. Gatilho de auditoria > 20%. Preparação de apresentação aos cooperados (agosto).",
    },
    {
        "tag": "ASSISTENCIAL",
        "titulo": "EVA-D 2026.1 — Apresentação à Direx",
        "resumo": "1ª análise semestral da Experiência e Valor na Atenção Domiciliar (GCE). Recorte até 30/06. Template oficial EVS consolidado. Instrumento de mensuração da experiência do paciente/cuidador.",
    },
]
OBSERVACOES = [
    "MOU 2iM: início previsto após 15/07; crítica do draft concluída.",
    ...
    "Dr. Matheus Tozzato (Reumatologia): em processo de credenciamento.",
]
...
if __name__ == "__main__":
    out = os.path.join(SCRIPT_DIR, "Signal_S28_2026.pdf")
