...
SEMANA = "37"
PERIODO = "7 a 11 de setembro de 2026"
DATA_GERACAO = "22/09/2026"
...
METRICAS = [
    ...
    ("9", "Movimentos no Dicionário"),
    ("v4.12", "Dicionário Oficial"),
]

FATOS = [
    {
        "tag": "FINANCEIRO",
        "titulo": "Bonificação DRG do Hospital Unihealth GV alcança 20%",
        "resumo": "A média mensal passou de R$ 44.690,32, na faixa anterior de 10%, para R$ 77.567,51 entre maio e julho. O aumento foi de R$ 32.877,19, ou 73,6%.",
    },
    {
        "tag": "GOVERNANÇA",
        "titulo": "Direx aprova o Epimed Monitor Controle de Infecção",
        "resumo": "A licença mensal será de R$ 4.180,00 a partir de janeiro de 2027. As integrações de ATB e Microbiologia somam R$ 14.300,00, em três parcelas, com treinamento web sem custo.",
    },
    {
        "tag": "OPERAÇÕES",
        "titulo": "Novo fluxo eletrônico do PPE-15 entra em operação",
        "resumo": "O atalho foi instalado nos tablets do Hospital Unihealth GV em 9 de setembro, com início da coleta no dia seguinte. O processo exige o registro correto do número de atendimento para análise das respostas.",
    },
    {
        "tag": "ASSISTENCIAL",
        "titulo": "Quálix para atendimento ao TEA ganha reconhecimento estadual",
        "resumo": "A Unimed GV foi a primeira Singular avaliada, com a Casa Unimed e três clínicas. Todos os serviços foram certificados: dois Selos Ouro e dois Bronze; o CTE recebeu o relatório e iniciou as melhorias.",
    },
    {
        "tag": "ESTRATÉGIA",
        "titulo": "Indicadores da Diretoria ganham governança mensal no Interact",
        "resumo": "A apresentação padronizada foi concluída para as reuniões mensais. Gestores revisarão atualização, metas e relevância, com a Gestão da Qualidade responsável por obsolescências e ajustes.",
    },
    {
        "tag": "DADOS",
        "titulo": "GCE amplia a base de testes do Navia",
        "resumo": "Em 10 de setembro, o Gerenciamento de Casos Especiais encaminhou registros clínicos para complementar os testes da plataforma. A validação posterior ficou fora do período desta edição.",
    },
]

OBSERVACOES = [
    "UniBlue: jurídicos avançaram no agendamento para tratar pontos da minuta e regras do FIDC.",
    "Ciclo de Aprendizagem: o GCE recebeu proposta da Cora Home Care; análise pendente no período.",
]
...
if __name__ == "__main__":
    out = os.path.join(SCRIPT_DIR, "Signal_S37_2026.pdf")
