...
SEMANA = "25"
PERIODO = "16 a 20 de junho de 2026"
DATA_GERACAO = "26/06/2026"
...
METRICAS = [
    ...
    ("9", "Novos termos"),
    ("v4.3", "Dicionário Oficial"),
]
FATOS = [
    {
        "tag": "VBHC",
        "titulo": "Calculadora de Valor — Resultados 1Q2026 Aprovados pela Direx",
        "resumo": "Análise dos resultados do 1o quadrimestre da Remuneração Médica Baseada em Valor (Medicina Interna do Adulto, Hospital Unihealth). Performance Final = IV × 80% + IM × 20%. Modelo desvinculado de marca externa, tratado institucionalmente pelo EVS. Evolução aprovada pela Diretoria Executiva.",
    },
    {
        "tag": "ESTRATÉGIA",
        "titulo": "Programa Nacional de Cirurgia Robótica e Telecirurgia — 2a Edição",
        "resumo": "Circular DMM 043/26 da Federação/Unimed do Brasil. Diretoria autorizou participação da Unimed GV. Dr. Guilherme Thomé e Dr. Daniel Gloria designados como responsáveis pelo preenchimento do formulário oficial.",
    },
    {
        "tag": "TECNOLOGIA",
        "titulo": "BPM Oncologia — Monitoramento Assistencial por Claims",
        "resumo": "TI Unimed GV (Cleverson Almeida) entregou BPM de monitoramento orientado a Claims para a LC Câncer Ginecológico. Parceria EVS + Coordenação do Cuidado + HI! + TI. Monitoramento de 160 beneficiárias com alertas automáticos de utilização.",
    },
    {
        "tag": "INFRAESTRUTURA",
        "titulo": "Locação RM 1,5T — Proposta Comercial Assinada",
        "resumo": "Proposta da Uniblue (Magnetom Flow Ace B60 1.5T) assinada pelo Dr. Marcus Miguel em 19/06. Processo de locação de ressonância magnética avançado para fase contratual no Hospital Unihealth.",
    },
    {
        "tag": "GOVERNANÇA",
        "titulo": "Revisão Salarial Médicos GCE — Proposta à Direx",
        "resumo": "Proposta de reestruturação do modelo de pagamento dos médicos do GCE apresentada à Direx (22/06). Fase 1 (imediata): revisão do valor de consultas de atenção domiciliar. Visita domiciliar = 2 consultas. A partir de 01/07/2026: consulta de consultório = R$ 120.",
    },
    {
        "tag": "DADOS",
        "titulo": "Unimetrics/CIG — Envio de Dados à Faculdade",
        "resumo": "Processo de envio de dados clínicos evoluindo positivamente junto à Faculdade. Status de andamento reportado pela Coordenadora do EVS (18/06). Parceria acadêmica em fase de consolidação.",
    },
]
OBSERVACOES = [
    "Release ICDS × Unimed Axis: texto validado pelo Dr. Dionir; aguardando validação final da Unimed GV.",
    "HACOR — Entregáveis 1o Ciclo: ensino, capacitação e centro de pesquisa em discussão.",
    "Psiquiatria CAI: alinhamento de pagamento formalizado entre CAI e Contas Médicas.",
    "Reuma Sem Fronteiras do Leste Mineiro (20/06): Guilherme Thomé como Speaker (Abbvie, Ipatinga/MG).",
]
...
if __name__ == "__main__":
    out = os.path.join(SCRIPT_DIR, "Signal_S25_2026.pdf")
