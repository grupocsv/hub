...
As edições seguem o formato **NNN/AAAA**, onde:

- **NNN** — número sequencial da edição no ano (001, 002, 003...)
- **AAAA** — ano de publicação (2026, 2027...)

Exemplo: `001/2026` é a primeira edição do ano de 2026.
...
| [Guia Operacional](skills/gerar-compass.md) | Passo a passo para produzir e publicar novas edições |
| [Template de Edição](templates/compass_template.md) | Modelo padrão para novas edições |
