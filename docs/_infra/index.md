...
<div class="copy-bar">
<button class="copy-bar-btn" id="copy-md-btn">
...
<tr><td><strong>Themis™</strong></td><td>Suporte técnico médico jurídico.</td><td><a href="https://themis.grupocsv.com">themis.grupocsv.com</a></td><td>Cloudflare Worker + Workflows + R2 + Supabase</td></tr>
...
<tr><td><code>themis</code></td><td>themis.grupocsv.com/*</td><td>Workflow: <code>themis-processing</code>, R2: <code>themis-private</code>, Supabase, Workers AI e AI Gateway <code>themis-generation</code></td><td>WebApp interno para análise documental e processamento durável; piloto limitado a dados sintéticos, com casos classificados como <code>restricted</code> bloqueados</td></tr>
...
<tr><td><strong>Cloudflare AI — Themis™</strong></td><td>Piloto Workers AI</td><td>AI Gateway <code>themis-generation</code>; somente dados sintéticos, com casos classificados como <code>restricted</code> bloqueados</td></tr>
</tbody>
</table>
</div>
...
<div class="empresa-block" style="border-top: none; margin-top: 16px; padding-top: 0;"><div class="empresa-header"><img src="https://assets.grupocsv.com/logos/axiacare/horizontal-positivo.svg" alt="AxiaCare" class="theme-logo--light"><img src="https://assets.grupocsv.com/logos/axiacare/horizontal-negativo.svg" alt="AxiaCare" class="theme-logo--dark"><h4>AxiaCare® — Consultoria e Governança Clínica</h4></div><div class="resource-grid"><a class="resource-btn axia" href="/_infra/axiacare/mandate">Mandato AxiaCare</a></div></div>
<div class="empresa-block"><div class="empresa-header"><img src="https://assets.grupocsv.com/logos/medvalor/horizontal-positivo-laranja.svg" alt="MedValor" class="theme-logo--light"><img src="https://assets.grupocsv.com/logos/medvalor/horizontal-negativo-laranja.svg" alt="MedValor" class="theme-logo--dark"><h4>MedValor® — Educação e Capacitação</h4></div><div class="resource-grid"><a class="resource-btn medvalor" href="/_infra/medvalor/mandate">Mandato MedValor</a></div></div>
<div class="empresa-block"><div class="empresa-header"><img src="https://assets.grupocsv.com/logos/thera/horizontal-positivo-roxo.svg" alt="Thera" class="theme-logo--light"><img src="https://assets.grupocsv.com/logos/thera/horizontal-negativo-roxo.svg" alt="Thera" class="theme-logo--dark"><h4>Thera® — Desenvolvimento de Software e Tecnologia</h4></div><div class="resource-grid"><a class="resource-btn thera" href="/_infra/thera/mandate">Mandato Thera</a></div></div>
</div>
...
| Themis™ | Suporte técnico médico jurídico. | themis.grupocsv.com | Cloudflare Worker + Workflows + R2 + Supabase |
...
| themis | themis.grupocsv.com/* | Workflow: themis-processing, R2: themis-private, Supabase, Workers AI e AI Gateway themis-generation | WebApp interno para análise documental e processamento durável; piloto limitado a dados sintéticos, com casos classificados como restricted bloqueados |
...
| Cloudflare AI — Themis™ | Piloto Workers AI | AI Gateway themis-generation; somente dados sintéticos, com casos classificados como restricted bloqueados |
