...
.operation-card {
  --operation-title: #196396;
  --operation-description: #5b6470;
...
.dark .operation-card {
  --operation-title: #5da9e0;
  --operation-description: var(--vp-c-text-2);
  ...
  <div class="frame">
    ...
    <div style="display:grid; gap:16px; grid-template-columns:repeat(auto-fill, minmax(260px, 1fr));">
      <div class="operation-card">
        ...
        <h4 style="margin:0; font-size:0.95rem; color:var(--operation-title); border:none; line-height:1.4;">Sistema Unimed</h4>
        <p style="margin:0; font-size:0.84rem; color:var(--operation-description); line-height:1.5; flex-grow:1;">Catálogo institucional para consulta de entidades, códigos e ativos de identidade visual do Sistema Unimed.</p>
      ...
      <div class="operation-card">
        <span style="display:inline-block; font-size:0.7rem; font-weight:700; text-transform:uppercase; letter-spacing:0.6px; padding:3px 10px; border-radius:20px; width:fit-content; background:#d1fae5; color:#065f46;">Ativo</span>
        <h4 style="margin:0; font-size:0.95rem; color:var(--operation-title); border:none; line-height:1.4;">Propostas Comerciais</h4>
        <p style="margin:0; font-size:0.84rem; color:var(--operation-description); line-height:1.5; flex-grow:1;">Gerador de propostas comerciais padronizadas para consultoria e projetos.</p>
      ...
      <div class="operation-card">
        <span style="display:inline-block; font-size:0.7rem; font-weight:700; text-transform:uppercase; letter-spacing:0.6px; padding:3px 10px; border-radius:20px; width:fit-content; background:#d1fae5; color:#065f46;">Ativo</span>
        <h4 style="margin:0; font-size:0.95rem; color:var(--operation-title); border:none; line-height:1.4;">Solicitação de Reembolso</h4>
        <p style="margin:0; font-size:0.84rem; color:var(--operation-description); line-height:1.5; flex-grow:1;">Gerador de solicitações de reembolso padronizadas com geração de PDF.</p>
